...
class CategoryController extends Controller
{
    ...
    // return consultations according category_id
    public function service($id){

    $subServiceConsultation   = Consultation::where('category_id', $id)->get();
    return view('public/sub-service', compact('subServiceConsultation'));
    }
